// Hi-fi data + channel system
// Channels (4): Quotes · Orders (samples + EVMs) · TI.com (datasheets, app notes, product folders) · E2E (forum)
...
// 14 signals across the 4 channels
const SIGNALS = [
...
window.SYNTH_INSIGHTS = SYNTH_INSIGHTS;
