...
export const SIGNALS = [
  ...
  { id: "s18", time: "9:25a",    ch: "synth", who: "Priya Ramaswamy", co: "Northfield Sense",   text: "Pattern: sustained engagement",                              draftId: "d2", weight: "strong",
    title: "Sustained engagement",
    body: "EVM ordered → 2× app-note pulls → datasheet revisits. Momentum building toward design-in.",
    sigCount: 4 },
  ...
  { id: "s4",  time: "8:55a",    ch: "synth", who: "3 engineers",     co: "Acme Robotics",      text: "Pattern: convergence on buck regulators (30d)",             draftId: "d3", weight: "strong",
    title: "Buck regulator convergence",
    body: "Three engineers (M. Kapoor, J. Lin, S. Park) viewed TPS6521905 + LMR33630 within a 30-day window. Pattern suggests platform decision in flight.",
    sigCount: 8 },
